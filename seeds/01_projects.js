    ...
    .then(function () {
      return Promise.all([
        ...
        knex('projects').insert({
          ...
          description: 'Read with Doc McStuffins was featured in the App Store under "Best New Apps." It was also the top paid app in Education. Players can learn all about world building with hundreds of little lessons. Young readers can join the Disney Junior character, Doc McStuffins, to explore 5 engaging chapters of this app. Each chapter focuses on a different skill including, blending and decoding, site words and sentence formation. As the game design lead on this series of games, my responsibilities included rapid prototyping, curriculum design, liaising with external developers, narrative design and more.',
          type: 'game',
        ...
        knex('projects').insert({
          ...
          description: 'This is the first of two apps that comprise a 10-step learn to read program with the Disney Junior Doc McStuffins franchise. The app is targeted at 3 - 5 year old players each game (in a set of 10 games) enables the player to exercise a different skill that is essential to the process of learning to read. These skills include rhyming and alliteration, letter sounds, phonemes, syllables and letter tracings. As the game design lead on this series of games, my responsibilities included rapid prototyping, curriculum design, liaising with external developers, narrative design and more.',
          type: 'game',
          role: 'Game Design / Prototype Developer / Early Concepting',
          date: 'January, 2016',
        ...
        knex('projects').insert({
          ...
          description: 'Players can join Elsa, Anna, Olaf and other friends from Frozen as they run a Nature Park in the fictional land of Arendelle. The app includes two games that focus on early science curriculum for 3-5 year olds. Players can experiment with state change in a cooking simulation and learn about health and hygiene in a baby reindeer park. As a designer on this app, I met with Disney Animation Studio representatives to ensure that the gameplay and narrative construction aligned with franchise goals. I prototyped playful, tablet-based science experiments to include in the app and provided design documentation for external developers.',
          type: 'game',
          role: 'Game Design / Prototype Developer / Early Concepting',
          date: 'April, 2015',
        ...
        knex('projects').insert({
          ...
          description: "Players can join Mickey and friends on a math-filled space adventure. The app includes five games that enable children to practice early math skills. Players practice geometry and shape recognition by building rockets, explore the number line with Donald Duck, use spatial problem solving skills with Daisy, practice counting with Minnie Mouse and sort colors and shapes with Goofy. As a designer on this suite of 5-games, I prototyped gameplay, constructed puzzle-levels, provided build feedback to developers and ran playtesting sessions.",
          type: 'game',
          role: 'Game Design',
          date: 'November, 2014',
        ...
        knex('projects').insert({
          ...
          description: 'Hedelby is a binaural soundscape and series of visual mini-games that challenge players to navigate a narrative sound environment. Gameplay is comprised of various story interludes, mixed-in with audio-directional challenges. Hedelby was developed as a research project within the Interactive Media Division of USC’s School of Cinematic Arts. The game was developed in conjunction with USC’s Viterbi School of Engineering. The fictional setting of the soundscape is a prison (Hedelby) that housed notoriously dangerous criminals. It served as a last ditch placement for society’s most dangerous defects. As the project leader, I organized a team, recruited actors, worked with a screenwriter, recorded and edited audio and programmed in C#. For this project, I built DYI binaural recording device from a mannequin head, directional microphones and silicone ears.',
          type: 'sandbox',
        ...
        knex('projects').insert({
          id: 3,
          name: 'The Source',
          brief: 'The Source is a cooperative reasoning game based on real events surrounding the 1854 London Cholera epidemic.',
          description: 'It’s 1854 and a mysterious epidemic is sweeping through London Town. Only you know the crucial detail: the contaminant is in the water. Work together with your team to find the source well and shut down the pump before it’s too late… The Source is a cooperative reasoning game for 4 to 8 players based on real events that is built to emphasize group deduction and communication abilities. Unlike traditional card games, The Source gets you and friends moving and turns the entire room into your playspace. It works great as an icebreaker at events or parties, and is suitable for most ages and all gaming abilities.',
          type: 'sandbox',
          role: 'Designer',
          date: 'February, 2010',
