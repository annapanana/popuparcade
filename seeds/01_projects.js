    ...
    .then(function () {
      return Promise.all([
        ...
        knex('projects').insert({
          ...
          brief: 'Gathered Gardens in a data visualization and community management site for community gardeners that are part of Growing Gardens organization in Boulder, CO.',
